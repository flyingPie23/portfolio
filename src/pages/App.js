      ...
      <div className="flex">
        ...
        <div>
          <p className="text-light-gray mr-[40px] ">
            ...
            <br/>
            Straight after finishing high school I knew I wanted to get a career in software development. It started with a passion for game design and after starting the <a href="https://www.lewagon.com/" target="_blank"  className="text-header text-light-blue underline font-bold">le Wagon's</a> bootcamp
